...
class StatusApi(object):
    ...
    def admin_api_metrics_get(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.admin_api_metrics_get(callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.admin_api_metrics_get_with_http_info(**kwargs)
        else:
            (data) = self.admin_api_metrics_get_with_http_info(**kwargs)
            return data

    def admin_api_metrics_get_with_http_info(self, **kwargs):
        """
        GET /admin/apiMetrics
        Get API request metrics
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.admin_api_metrics_get_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method admin_api_metrics_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/admin/apiMetrics', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
