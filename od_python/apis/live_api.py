...
class LiveApi(object):
    ...
    def live_get(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.live_get(callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.live_get_with_http_info(**kwargs)
        else:
            (data) = self.live_get_with_http_info(**kwargs)
            return data

    def live_get_with_http_info(self, **kwargs):
        """
        GET /live
        Get top currently ongoing live games
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.live_get_with_http_info(callback=callback_function)
        ...
        return self.api_client.call_api('/live', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
